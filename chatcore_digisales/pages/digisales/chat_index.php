...
if (!isset($_SESSION['web_login'])) {
	redirect(base_url() . 'chatcore/pages/login_page.php?env=3');
}
		...
		<div class="row h-100">
			...
			<div class="d-none d-sm-flex flex-column col-12 col-sm-7 col-md-8 p-0 h-100" id="message-area">
				...
				<div class="d-none justify-content-end align-items-center flex-row bg-white" id="input-area">
					<textarea type="text" name="message" id="input" placeholder="Type a message here..." class="flex-grow-1 m-3 pl-3 pr-5 py-3" style="border-radius: 5px; position: relative; font-size: 12px; border: 0.5px solid #999999"></textarea>
