...
<head>
  ...
  <title><?php echo $env == 1 ? 'Qmera Web Chat' : 'Gaspol Web Chat' ?></title>
...
<body class="d-flex align-items-center">
  <div class="col">
    <div class="row" style="background-color: <?php echo $env == 1 ? '#6945A5' : 'darkorange' ?>;">
      <div class="col" style="margin-left: 40vh; margin-right: 20vh;">
        <div class="row" id="qr-row">
          ...
          <div class="col-xxl-8 bg-white" style="padding-right: 5rem; padding-left: 5rem;">
            <div class="row">
              <img src="<?php echo $env == 1 ? '/qmera_button/assets/palio_button.png' : '/chatcore/assets/img/logo_gaspol.svg' ?>" height="90rem">
            </div>
            <div class="row mt-4">
              <div>
                <p class="font-medium" style="font-size: 30px;">To use <?php echo $env == 1 ? 'Qmera Lite' : 'Gaspol' ?> on your computer</p>
                <div>
                  <ol type="1" style="padding-inline-start: 20px;">
                    <li>Open your  <?php echo $env == 1 ? 'Qmera Lite' : 'Gaspol' ?> mobile app.</li>
                    <li>Open settings menu by pressing burger menu on the upper right corner, go to "Settings", and go to "Login to  <?php echo $env == 1 ? 'Qmera Web' : 'Gaspol' ?>".</li>
            ...
            <div class="row mt-4">
              <div>
                ...
                <ol type="1" style="padding-inline-start: 20px;">
                  ...
                  <li>If you haven't installed  <?php echo $env == 1 ? 'Qmera Lite' : 'Gaspol' ?>, please do so.</li>
                </ol>
              </div>
            </div>
          </div>
