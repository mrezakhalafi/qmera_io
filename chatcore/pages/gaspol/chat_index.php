...
if (!isset($_SESSION['web_login'])) {
	redirect(base_url() . 'chatcore/pages/login_page.php?env=2');
}
...
<head>
	...
	<link rel="stylesheet" href="../../assets/css/style_gaspol.css?v=<?php echo time(); ?>">
...
<body>
	...
	<div class="modal fade" id="download-desktop" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
		<div class="modal-dialog modal-dialog-centered" role="document">
			<div class="modal-content">
				<div class="modal-header">
					<h5 class="modal-title" id="downloadDesktopLabel">Opening Gaspol Desktop</h5>
					<button type="button" class="close" data-dismiss="modal" aria-label="Close">
						<span aria-hidden="true">&times;</span>
					</button>
				</div>
				<div class="modal-body">
					If you haven't installed Gaspol Desktop on your computer, please download and do so <a href="/downloads/palio_installer.exe">here</a>.
				</div>
				<div class="modal-footer">
					<button type="button" id="open-desktop" class="btn btn-primary" data-dismiss="modal">Open Gaspol Desktop</button>
	...
	<script src="../../assets/js/gaspol/fetch_be_api_key.js"></script>
	<script src="../../assets/js/gaspol/fetch_company_alias.js"></script>
	<script src="../../assets/js/gaspol/fetch_complaint.js"></script>
	<script src="../../assets/js/gaspol/fetch_complaint_history.js"></script>
	<script src="../../assets/js/gaspol/fetch_user_type.js"></script>
	<script src="../../assets/js/gaspol/fetch_friend_list.js"></script>
	...
	<script src="../../assets/js/gaspol/fetch_notif_periodic.js"></script>
	<script src="../../assets/js/gaspol/fetch_notif_call_customer.js"></script>
	<script src="../../assets/js/gaspol/script.js?v=<?php echo time(); ?>"></script>
