<?php
    ...
    function customizeTemplateRemoteEmailConfirmation($name,$link){
        ...
        $content = str_replace('cid:image002', 'https://qmera.io/template/PalioEmailConfirmation_files/image002.png', $content);
        $content = str_replace('cid:image004', 'https://qmera.io/template/PalioEmailConfirmation_files/steps.jpg', $content);
        $content = str_replace('cid:image006', 'https://qmera.io/template/PalioEmailConfirmation_files/mail_icon.jpg', $content);
        // $content = str_replace('cid:image008', 'https://qmera.io/template/PalioEmailConfirmation_files/image008.png', $content);
        // $content = str_replace('cid:image010', 'https://qmera.io/template/PalioEmailConfirmation_files/image010.png', $content);
        // $content = str_replace('cid:image012', 'https://qmera.io/template/PalioEmailConfirmation_files/image012.png', $content);
